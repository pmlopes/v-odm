...
public class KVMapper {
  private final def io.vertx.orm.KVMapper delegate;
  public KVMapper(Object delegate) {
    this.delegate = (io.vertx.orm.KVMapper) delegate;
  }
  public Object getDelegate() {
    return delegate;
  }
  public static KVMapper create(RedisClient redis, String entity) {
    def ret= InternalHelper.safeCreate(io.vertx.orm.KVMapper.create((io.vertx.redis.RedisClient)redis.getDelegate(), entity), io.vertx.groovy.orm.KVMapper.class);
    return ret;
  }
